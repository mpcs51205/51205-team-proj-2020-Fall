...
dummy_item_update = {'name':'ben simmons', 'start_time':'2020-11-21 11:30:05', 'end_time':'2020-11-21 12:30:05', 'category':'nba_draft_2016', 'start_bidding_price':'6000000', 'buyout_price':'29000000', 'user_key':'0'}

r=requests.put(endpoints['mediator'].get_prefix() + "update_auction_item/"+args.key, data=json.dumps(dummy_item_update), headers={'Content-Type':'application/json'})
print(r.json())
...
#r=requests.put(endpoints['mediator'].get_prefix() + "remove_auction_item/"+args.key, headers={'Content-  Type':  'application/json'})
#print(r.json())
